...
var _user$project$Main$animateOnChange = function (text) {
	return A3(
		_elm_lang$html$Html$node,
		'animate-on-change',
		{
			ctor: '::',
			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'text', text),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			function (x) {
				return _user$project$Main$animateOnChange(
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A2(_elm_lang$core$List$repeat, 20, 0),
